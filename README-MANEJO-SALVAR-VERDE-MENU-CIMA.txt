Correção do Manejo - botão salvar rápido e menu acima

Alterações:
1. A coluna de ações do manejo agora possui um botão verde ✓ para salvar a edição rápida da linha.
2. O menu dos três pontos não traz mais a opção salvar, ficando apenas para ações extras.
