(() => {
  ...
  const LOCAL_RELEASE = "2026-08-01-chegada-confirmacao-estavel-72";
  ...
  function carregarModulos() {
    const modulos = [
      ...
      ["corponu-chegada-confirmacao-servico.js", "chegada-confirmacao-servico", "Não foi possível carregar a confirmação estável do serviço recebido."],
