(() => {
  ...
  const LOCAL_RELEASE = "2026-08-08-pagamentos-historico-seguro-159";
  ...
  function carregarModulos() {
    const modulos = [
      ...
      ["corponu-pagamentos-historico-seguro-159.js", "pagamentos-historico-seguro-159", "Não foi possível proteger os pagamentos históricos existentes."],
      ...
      ["corponu-pagamentos-filtro-op-v2-compat-158.js", "pagamentos-filtro-op-v2-compat-158", "Não foi possível estabilizar o filtro de OP V2 em Pagamentos."],
      ["corponu-pagamentos-filtro-op-performance-157.js", "pagamentos-filtro-op-performance-157", "Não foi possível carregar o filtro leve de OP em Pagamentos."],
