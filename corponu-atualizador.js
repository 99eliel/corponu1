(() => {
  ...
  const LOCAL_RELEASE = "2026-08-01-faccao-cadastro-recolhido-62";
  ...
  function carregarModulos() {
    const modulos = [
      ...
      ["corponu-faccao-cadastro-recolhido.js", "faccao-cadastro-recolhido", "Não foi possível recolher o formulário de cadastro da facção."],
