(() => {
  ...
  const LOCAL_RELEASE = "2026-07-31-sutia-completo-calculo-51";
  ...
  function carregarModulos() {
    const modulos = [
      ...
      ["corponu-sutia-completo-calculo.js", "sut ia-completo-calculo", "Não foi possível carregar o cálculo automático do Sutiã Completo."],
