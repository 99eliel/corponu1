(() => {
  ...
  const LOCAL_RELEASE = "2026-08-01-chegada-correcao-rapida-80";
  ...
  function carregarModulos() {
    const modulos = [
      ...
      ["corponu-chegada-confirmacao-rapida.js", "chegada-correcao-rapida", "Não foi possível carregar a correção rápida de processo e facção na chegada."],
