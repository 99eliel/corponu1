(() => {
  ...
  const LOCAL_RELEASE = "2026-08-01-chegada-confirmacao-final-83";
  ...
  function carregarModulos() {
    const modulos = [
      ...
      ["corponu-chegada-confirmacao-rapida.js", "chegada-confirmacao-final", "Não foi possível carregar a confirmação final de processo e facção na chegada."],
