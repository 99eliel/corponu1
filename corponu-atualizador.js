(() => {
  ...
  const LOCAL_RELEASE = "2026-08-01-chegada-restaurada-74";
  ...
  function carregarModulos() {
    const modulos = [
      ...
      ["corponu-chegada-confirmacao-servico.js", "chegada-restaurada", "Não foi possível restaurar o modal simples de chegada."],
