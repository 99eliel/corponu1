...
try {
  $listener.Start()
  $url = "http://127.0.0.1:$Port/homologacao-v2/"

  Write-Host ""
  Write-Host "============================================================"
  Write-Host " CORPO NU FLOW - HOMOLOGACAO V2"
  Write-Host " AMBIENTE LOCAL - NAO E PRODUCAO"
  Write-Host "============================================================"
  Write-Host ""
  ...
  while ($true) {
    ...
    try {
      ...
      if ($requestPath -eq "/") { $requestPath = "/homologacao-v2/" }
  ...
  Write-Host ""
  Write-Host "Nao foi possivel iniciar a homologacao." -ForegroundColor Red
  Write-Host $_.Exception.Message -ForegroundColor Red
  Write-Host ""
  Write-Host "Se a porta 8765 ja estiver em uso, feche outra homologacao aberta e tente novamente."
