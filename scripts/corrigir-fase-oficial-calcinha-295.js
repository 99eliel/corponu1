...
const arquivo = 'corponu-manejo-calcinha-dedicado-253.js';
...
substituirUnico(
  ...
  'constante de datalist da Calcinha 253'
);
...
for (const proibido of [
  ...
  if (source.includes(proibido)) throw new Error(`fonte legada ainda presente: ${proibido}`);
}
...
console.log('Fase oficial da Calcinha aplicada estruturalmente no módulo 253.');
