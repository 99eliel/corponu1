(() => {
  const APP_VERSION = "2026-09-10-rastreamento-acoes-controlador-308";
  ...
  let reparoListasPrincipaisV299Promessa = null;
  ...
  async function mesclarFasesLateralRecuperadas(recuperadas) {
    const contexto = contextoGestaoFasesLateral();
