(() => {
  ...
  const LOADER_VERSION = "2026-08-11-admin-edita-componentes-chegada-175";
  const BASE_FILE = "corponu-sutia-completo-calculo-base-174.js";
  const GUARD = "__CORPONU_SUTIA_COMPLETO_ADMIN_LOADER_175__";
  ...
  function aplicarEdicaoAdmin(fonteOriginal) {
    ...
    substituir(
      ...
      'const VERSION = "2026-08-11-admin-edita-componentes-chegada-175";',
      "versão interna"
    );
