...
try {
  $listener.Start()
  $url = "http://127.0.0.1:$Port/firebase-v2-pagamentos-leitura/"

  Write-Host ""
  Write-Host "============================================================"
  Write-Host " CORPO NU FLOW V2 - FIREBASE REAL"
  Write-Host " PAGAMENTOS - SOMENTE LEITURA"
  Write-Host "============================================================"
  Write-Host ""
  Write-Host "Servidor local iniciado em: $url"
  Write-Host "Filtros e relatorios estao liberados."
  Write-Host "Quitacao e qualquer escrita permanecem bloqueadas."
  ...
  while ($true) {
    ...
    try {
      ...
      if ($requestPath -eq "/") { $requestPath = "/firebase-v2-pagamentos-leitura/" }
  ...
  Write-Host ""
  Write-Host "Nao foi possivel iniciar a validacao de Pagamentos." -ForegroundColor Red
  Write-Host $_.Exception.Message -ForegroundColor Red
  Write-Host ""
  Write-Host "Se a porta 8770 ja estiver em uso, feche outra validacao aberta e tente novamente."
