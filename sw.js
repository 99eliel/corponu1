const APP_VERSION = "2026-07-26-rastreamento-ir-local-1";
const CACHE_NAME = `op-confeccao-${APP_VERSION}`;

const CORE_ASSETS = [
  "./",
  "./index.html",
  "./style.css?v=2026-07-26-rastreamento-ir-local-1",
  "./app.js?v=2026-07-26-rastreamento-ir-local-1",
  "./update.js?v=2026-07-26-rastreamento-ir-local-1",
  "./version.json"
];
