(() => {
  ...
  function observarTabela() {
    ...
    observerTabela = new MutationObserver(() => {
      // Reaplica apenas valores realmente alterados. Não força foco e não interfere
      // na lista nativa de sugestões da Fase.
      restaurarDrafts();
    });
  ...
  function instalarEventos() {
    ...
    // A opção escolhida no datalist é capturada primeiro. Depois disso qualquer
    // reconstrução do tbody passa a restaurar a nova escolha, nunca a anterior.
